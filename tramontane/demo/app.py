"""TRAMONTANE v0.2.4 — Memory + Skills Demo.
...
# ---------------------------------------------------------------------------
# Fleet table (updated for v0.2.4)
# ---------------------------------------------------------------------------
...
{downgrade_note}
---
*v0.2.4 \u00b7 OFFLINE mode \u00b7 13 models \u00b7 No API key required*
"""
...
with gr.Blocks(
    title="TRAMONTANE v0.2.4 \u2014 Memory + Skills",
